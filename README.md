...
**Autonomous Cyber Operations Agent** — 98 tools across 6 security domains, powered by AI (OpenAI / Ollama).
...
|--------|-------|-------------|
| 🔴 Quarr Red | 49 | Web, API, Network, Mobile, AD pentest |
...
| [USAGE.md](docs/en/USAGE.md) | Full guide — all 98 tools, setup, config |
...
| [USAGE.md](docs/id/USAGE.md) | Panduan lengkap — 98 tools, setup, konfigurasi |
